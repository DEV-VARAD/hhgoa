...
function App() {
  ...
  return (
    <main className={`app ${theme === "light" ? "light-theme" : ""}`}>
      <section className={`intro-curtain ${showIntro ? "" : "intro-curtain--open"}`} aria-hidden={!showIntro}>
        <div className="curtain-panel curtain-panel--left"><div className="palm palm--top" /><div className="palm palm--bottom" /></div>
        <div className="curtain-panel curtain-panel--right"><div className="palm palm--top" /><div className="palm palm--bottom" /></div>
      ...
      <nav className="navbar">
        <div className="brand">
          ...
          {(transcript || result) && <button className="reset-btn" onClick={reset}><RotateCcw size={16} />New question</button>}
          <button
          ...
          <div className="profile-menu-group" onMouseLeave={() => setOpenProfile(null)}>
            <div className="profile-wrapper" onMouseEnter={() => setOpenProfile("you")}>
              <button
                className={`profile-trigger ${openProfile === "you" ? "active" : ""}`}
                onClick={() => setOpenProfile(openProfile === "you" ? null : "you")}
              ...
              {openProfile === "you" && (
                <div className="profile-dropdown">
                  ...
                  <a href="https://www.linkedin.com/in/varad-yadav/" target="_blank" rel="noreferrer"><Link size={15} />LinkedIn</a>
                  <a href="https://github.com/DEV-VARAD" target="_blank" rel="noreferrer"><Link size={15} />GitHub</a>
                  <a href="https://x.com/varadkf" target="_blank" rel="noreferrer"><X size={15} />X</a>
                </div>
              )}
            </div>

            <div className="profile-wrapper" onMouseEnter={() => setOpenProfile("friend")}>
              <button
                className={`profile-trigger profile-trigger--friend ${openProfile === "friend" ? "active" : ""}`}
                onClick={() => setOpenProfile(openProfile === "friend" ? null : "friend")}
                aria-label="Open Sarvesh's social links"
                aria-expanded={openProfile === "friend"}
                type="button"
              >
                <img src={sarveshImage} alt="Sarvesh" className="profile-img" />
                <span>Sarvesh</span>
              </button>
              {openProfile === "friend" && (
                <div className="profile-dropdown">
                  <strong>Sarvesh's links</strong>
                  <a href="https://www.linkedin.com/in/sarvesh-patil-75060721a" target="_blank" rel="noreferrer"><Link size={15} />LinkedIn</a>
                  <a href="https://github.com/Sarvesh-107" target="_blank" rel="noreferrer"><Link size={15} />GitHub</a>
                  <a href="https://x.com/XENOGAM59155308" target="_blank" rel="noreferrer"><X size={15} />X</a>
                </div>
              )}
            </div>
          </div>
      ...
      <section className="hero">
        <div className="badge"><span className="live-dot" />HH GOA 2026 · VOICE ENABLED RAG</div>
  ...
  >
    ...
    <span className="suggestion-text">
      ...
      <section className="workspace">
        ...
        {result && <><AnswerCard result={result} /><LatencyMetrics latency={result.latency_ms} /></>}
      </section>

      <footer><Mic size={14} />Voice → STT → Retrieval → Grounded Generation</footer>
    </main>
  );
}
